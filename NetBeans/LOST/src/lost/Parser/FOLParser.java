...
public class FOLParser extends Parser {
	...
	public static final int
		RULE_condition = 0, RULE_formula = 1, RULE_term = 2, RULE_quantifier = 3, 
	...
	public final FormulaContext formula(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(18); quantifier();
				setState(19); formula(7);
				}
				break;

			case 2:
				{
				setState(21); match(NOT);
				setState(22); formula(6);
				}
				break;
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 3:
						...
						setState(43); match(IMPLIES);
						setState(44); formula(4);
						}
						break;
